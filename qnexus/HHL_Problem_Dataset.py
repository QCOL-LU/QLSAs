...
def generate_full_dataset():
    ...
    condition_numbers = [2, 5, 10, 20, 50]
...
def create_readme(output_dir="problems"):
    """
    Create a comprehensive README file for the dataset.
    
    Parameters
    ----------
    output_dir : str
        Directory where the README will be saved
    """
    readme_content = """# HHL Problem Dataset
...
"""
    ...
    print(f"README.md created in '{output_dir}/' directory")
